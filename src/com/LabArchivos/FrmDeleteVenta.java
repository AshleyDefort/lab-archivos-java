 ...
 * @author ashle
 */
public class FrmDeleteVenta extends javax.swing.JFrame {

    /**
     * Creates new form FrmDeleteVenta
     */
    public FrmDeleteVenta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 300, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDeleteVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDeleteVenta().setVisible(true);
            }
        });
    }
